-- ════════════════════════════════════════════════════════════════════════════
-- AUDIT R19 HARDENING — fixes P0 de auditoría hostil
--
-- Atiende 4 hallazgos REALES del audit R19:
--
...
COMMENT ON CONSTRAINT no_appointment_overlap ON appointments IS
  'AUDIT R19 P0.2 — previene double-booking parcial. Reemplaza uniq_appointment_slot.';
