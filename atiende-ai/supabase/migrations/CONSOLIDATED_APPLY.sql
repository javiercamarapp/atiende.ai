-- ══════════════════════════════════════════════════════════════════════════
-- CONSOLIDATED MIGRATION — PEGAR EN SUPABASE SQL EDITOR
-- Ejecutar de arriba a abajo. Todo idempotente (safe re-run).
-- Orden: (1) Phase 1 tool calling → (2) Phase 2.C intelligence P0 →
--        (3) Phase 3.A schema extendido → (4) Phase 3.D fixups
-- ══════════════════════════════════════════════════════════════════════════

-- ┌─ BLOQUE 1/4: PHASE 1 — TOOL CALLING SETUP ──────────────────────────────┐
-- ════════════════════════════════════════════════════════════════════════════
...
-- ┌─ BLOQUE 2/4: PHASE 2.C — INTELLIGENCE P0 ───────────────────────────────┐
-- ════════════════════════════════════════════════════════════════════════════
...
-- ┌─ BLOQUE 3/4: PHASE 3.A — SCHEMA EXTENSIONS ─────────────────────────────┐
-- ════════════════════════════════════════════════════════════════════════════
...
-- ┌─ BLOQUE 4/4: PHASE 3.D — FIXUPS POST-HOC ───────────────────────────────┐
-- ════════════════════════════════════════════════════════════════════════════
