...
import { ShoppingBag, DollarSign, Zap, MessageSquare } from 'lucide-react';
...
export function DashboardGastronomia({ roi, todayData, monthData, conversations }: IndustryDashProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {[{l:'Mensajes hoy',v:todayData?.messages_inbound||0,I:MessageSquare},{l:'Pedidos hoy',v:todayData?.orders_total||0,I:ShoppingBag},{l:'Revenue hoy',v:fmt(todayData?.orders_revenue||0),I:DollarSign},{l:'Pedidos mes',v:tOrders,I:ShoppingBag}].map(k=>(
