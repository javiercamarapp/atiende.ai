...
export const DOCTOR_PLAN_FEATURES: Record<DoctorPlan, string[]> = {
  ...
  pro: [
    'Todo Esencial',
    'Marketing AI (cobranza, reseñas, reactivación)',
    'Personal AI (personalización avanzada)',
    'Lista de espera + citas recurrentes + familiares',
    'Pagos con Stripe + Facturación CFDI',
    'Telemedicina',
  ],
  ultimate: [
    'Todo Pro',
    'Agente de voz (200 min/mes incluidos)',
    'Multi-sucursal',
    'Analytics avanzado',
    'Soporte prioritario',
  ],
