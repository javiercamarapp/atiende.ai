...
import {
  ...
  Cake, Smile, RotateCcw, ClipboardCheck,
} from 'lucide-react';
              ...
              <textarea
                ...
                placeholder={
                  mode === 'contenido'
                    ...
                    : 'Describe la campaña que quieres lanzar…'
                }
                disabled={loading}
  ...
  return (
    <div className="h-full flex flex-col items-center justify-center text-center max-w-2xl mx-auto">
      ...
      <h2 className="mt-5 text-2xl md:text-3xl font-semibold tracking-tight text-zinc-900">
        {mode === 'contenido' ? '¿Qué quieres crear hoy?' : '¿Qué campaña quieres lanzar?'}
      </h2>
      <p className="mt-2 text-sm text-zinc-500 max-w-md">
        {mode === 'contenido'
          ? 'Posts, correos, anuncios y hashtags. Estilo personalizado con la voz de tu clínica.'
          : 'Broadcasts de WhatsApp, reactivación, recordatorios y más. Dirigidos al público correcto.'}
      </p>
